...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
     ...
     * @return $this
     */
    public function whereHas(string $relation, \SOSTheBlack\Repository\Contracts\closure $closure)
    {
     ...
     * @return $this
     */
    public function skipPresenter(bool $status = true)
    {
     ...
     *
     * @return $this
     * @throws \SOSTheBlack\Repository\Exceptions\RepositoryException
     */
